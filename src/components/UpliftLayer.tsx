...
import { Cpu, ChevronRight, Network, Wind } from 'lucide-react';
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-400">
            ...
            to generate measurable project basis-point uplift and strengthen exits.
          </p>
        </div>
          ...
          {steps.map((step, idx) => (
            <div key={step.id} className="relative group">
              <div className="p-6 bg-brand-surface border border-white/5 rounded-xl hover:border-brand-accent/30 transition-all h-full flex flex-col">
                <div className="text-4xl font-bold text-brand-accent/20 mb-4 group-hover:text-brand-accent/40 transition-colors">
                  0{step.id}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-brand-surface rounded-2xl overflow-hidden border border-white/10 group">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-400">
                Integrates time-series, geospatial, and physics data into a single environment for
          ...
          <div className="bg-brand-surface rounded-2xl overflow-hidden border border-white/10 group">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-400">
                Multi-agent systems coordinating energy flows and grid interactions in real-time.
              </p>
            </div>
          </div>
          ...
          <div className="bg-brand-surface rounded-2xl overflow-hidden border border-white/10 group">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-400">
                Replacing heuristic estimation with deterministic prediction for objective optimization.
              </p>
            </div>
          </div>
        </div>
