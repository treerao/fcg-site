  ...
  return (
    <section id="team" className="py-24 bg-brand-surface border-t border-white/5 scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="mb-12">
          <h2 className="text-sm font-mono text-brand-accent tracking-widest uppercase mb-4">Leadership</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white">Foresight + Uplift Team</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {teamMembers.map((member, idx) => (
            <div key={idx} className="p-6 bg-brand-dark border border-white/5 rounded-lg hover:border-brand-accent/40 transition-colors group">
        ...
        <div className="mt-12 text-center">
            <p className="text-gray-400">Plus a deep bench of experts from Google X, DeepMind, and Institutional Finance.</p>
        </div>
      </div>
    </section>
  );
