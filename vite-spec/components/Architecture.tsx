...
import { Layers, Lightbulb, Rocket, RefreshCw } from 'lucide-react';
    ...
    <section id="architecture" className="py-24 bg-brand-dark relative scroll-mt-24">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-sm font-mono text-brand-accent tracking-widest uppercase mb-4">The Foresight Architecture</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white">Capital & Innovation Compounding Value</h3>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative z-10">
            ...
            >
              ...
              <p className="text-gray-400 mb-6">Private equity fund focused on AI-uplifted IRR in nextgen infrastructure projects.</p>
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-2">Foresight<br/>Capital Group</h4>
              <p className="text-sm text-gray-400 px-6">
                Reflexive Value Creation Loop
              </p>
            ...
            >
              ...
              <div className="bg-brand-surface border border-white/10 rounded-2xl p-8 group hover:border-brand-accent/30 transition-colors">
                ...
                <p className="text-gray-400 text-sm">
                  AI R&D center generating IRR uplift on projects and equity share of innovation via IP licenses.
                </p>
              </div>
