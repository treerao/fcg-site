  ...
  return (
    <section id="contact" className="py-24 bg-brand-dark relative overflow-hidden scroll-mt-24">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <h2 className="text-sm font-mono text-brand-accent tracking-widest uppercase mb-4">Investment Opportunity</h2>
        <h3 className="text-4xl md:text-5xl font-bold text-white mb-8">
          Join the Compounding Flywheel
        </h3>
        <p className="max-w-2xl mx-auto text-gray-400 mb-10 text-lg">
          We are currently raising an evergreen rolling $55M capped round. 
          Investors receive GP & Fee interests in Funds I-IV and Equity Stake in Uplift Lab shuttles.
        </p>
